...
# ================= CLASS MAPS =================
LEAF_MERGE_MAP = {
    # Display names for the five classes in the deployed yolov11s_leaf.onnx
    # (Ultralytics 8.4.63 export, 2026-06-17; SHA256 1934813e2319fa1f...).
    # The previous map targeted an earlier taxonomy ("algal_leave",
    # "anthracnose", "early_blight") whose classes no longer exist in the
    # deployed weights; see audit/verify_model_classes.py.
    "algal":     "Algal Spot",
    "leaf_rot":  "Leaf Rot",
    "phomopsis": "Phomopsis",
    "pink":      "Pink Disease",
...
PEST_COLORS = {
    # Seven classes in the deployed yolov11n_pest.onnx
    # (Ultralytics 8.4.63 export, 2026-06-19; SHA256 45f18a01d6e0936a...).
